...
export default function EditWorkout() {
  ...
  const { updateWorkout, getWorkout } = useWorkouts()
  ...
  useEffect(() => {
    ...
    setWorkoutExercises(workout.exercises.map(exercise => ({
      ...exercise,
      notes: exercise.notes || ''
    })))
  }, [id, getWorkout, navigate])
    ...
    <div className="container mx-auto px-4 py-4 sm:py-8">
      <div className="flex items-center gap-4 mb-6 sm:mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold">
          Edit Workout - {workoutDate ? format(new Date(workoutDate), 'MMMM d, yyyy') : 'Loading...'}
        </h1>
      </div>
